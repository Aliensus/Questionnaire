...
// Правильных ответов на вопрос может быть как один, так и несколько - это задается признаком isSingleAnswer
data class Question(
    ...
    val ratePolicy: RatePolicy, // политика оценки ответа на этот вопрос (см.ниже)
...
// Можно дополнять новыми политиками, дописав их обработку далее в приложении.
